...
(function () {
  ...
  window.addEventListener("load", function () {
    setTimeout(function () {
      // Wszystkie pliki sa variable fonts (os wght) z Google Fonts — jeden plik per
      // zakres unicode obsluguje cala skale wag. Browser interpoluje wage przez axis,
      // wiec latin i latin-ext zawsze maja tak sama gestosc kresek dla danej wagi.
      var LATIN_RANGE = "U+0000-00FF,U+0131,U+0152-0153,U+02BB-02BC,U+02C6,U+02DA,U+02DC,U+0304,U+0308,U+0329,U+2000-206F,U+20AC,U+2122,U+2191,U+2193,U+2212,U+2215,U+FEFF,U+FFFD";
      var LATIN_EXT_RANGE = "U+0100-02BA,U+02BD-02C5,U+02C7-02CC,U+02CE-02D7,U+02DD-02FF,U+0304,U+0308,U+0329,U+1D00-1DBF,U+1E00-1E9F,U+1EF2-1EFF,U+2020,U+20A0-20AB,U+20AD-20C0,U+2113,U+2C60-2C7F,U+A720-A7FF";
      var fonts = [
        new FontFace("Hanken Grotesk", "url('/fonts/hanken-grotesk-latin.woff2')",     { weight: "100 900", style: "normal", display: "swap", unicodeRange: LATIN_RANGE }),
        new FontFace("Hanken Grotesk", "url('/fonts/hanken-grotesk-latin-ext.woff2')", { weight: "100 900", style: "normal", display: "swap", unicodeRange: LATIN_EXT_RANGE }),
        new FontFace("JetBrains Mono", "url('/fonts/jetbrains-mono-latin.woff2')",     { weight: "100 800", style: "normal", display: "swap", unicodeRange: LATIN_RANGE }),
        new FontFace("JetBrains Mono", "url('/fonts/jetbrains-mono-latin-ext.woff2')", { weight: "100 800", style: "normal", display: "swap", unicodeRange: LATIN_EXT_RANGE }),
      ];
